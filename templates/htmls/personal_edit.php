	...
	<div class="contentWrapper">
		...
		<div class="bd_ddd mg_t20">
		 ...
		 <ul class="commBox clearfix mg_t40">
			...
			<li>
				<input type="radio" onclick="selectPaytime(1)" value="已在职" name="flag">已在职
				<input type="radio" onclick="selectPaytime(2)" value="求职中" name="flag">求职中    
				<input type="radio" onclick="selectPaytime(3)" target="interview" value="面试" name="flag"> 面试 
				<input type="radio" onclick="selectPaytime(5)" value="转正" name="flag"> 转正  
				<input type="radio" onclick="selectPaytime(6)" value="离职" name="flag"> 离职	
				<div class='pops' id="interview">
					<label>面试时间：</label>
					<input type="text" readonly="readonly" onclick="WdatePicker()" value="" class="inpCom w200 Wdate" name="interviewDate">
				</div>
				<div class='pops' id="offered">
					<label>面试时间：</label>
					<input type="text" readonly="readonly" onclick="WdatePicker()" value="" class="inpCom w200 Wdate" name="interviewDate">
				</div>
			</li>
			<li style="display:none" id="ddanwei">
			   <label>工作单位：</label>
			...
			<li>
				<label>入职时间：</label>
				<input type="text" readonly="readonly" onclick="WdatePicker()" value="" class="inpCom w200 Wdate" >  
			</li>
			<li style="display:none" id="dzzdate">
				<label>转正时间：</label>
				<input type="text" readonly="readonly" onclick="WdatePicker()" value="" maxlength="50" size="25" class="inpCom w200 Wdate" id="age" name="zzdate">  
			</li>
			<li style="display:none" id="dlzdate">
				<label>离职时间：</label>
				<input type="text" readonly="readonly" onclick="WdatePicker()" value="" maxlength="50" size="25" class="inpCom w200 Wdate" >  
			</li>
			<li>
				<label>是否面试：</label> 
				<input type="hidden" value="1" id="ms" name="ms">
				<select onchange="show(this.value)" name="isms"  class="selCom w100">
			...
			<li id="dmsdate1">
			    <label>面试企业：</label>
			    <select name="coname" class="selCom w350"> 
					<option value="">选择面试企业</option>
					<option value="23">健道科技</option>
					<option value="22">先锋智道</option>
					<option value="21">旗计智能</option>
					<option value="20">中信银行客服</option>
					<option value="19">海王星辰（药店）</option>
					<option value="17">蔻露饮用水</option>
					<option value="16">天宝影城</option>
					<option value="14">安泰中智</option>
					<option value="13">邮电器材</option>
					<option value="12">水环地调</option>
					<option selected="selected" value="9">263网科</option>
					<option value="6">小米科技</option>
					<option value="5">爱康国宾</option>
				</select>
			</li>
			<li>
			   <label>面试时间：</label>
				<input type="text" readonly="readonly" onclick="WdatePicker()" value="2015-02-10" maxlength="50" size="25" class="inpCom w300" name="msdate">
			</li>
			<li>
			   <label>备注信息：</label>
